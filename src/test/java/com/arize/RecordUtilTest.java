...
public class RecordUtilTest {
  ...
  protected Map<String, Value> embeddingMap;
  ...
  @Test
  public void testConvertInvalidEmbeddingFeaturesEmptyVector() {
  ...
  @Test
  public void testConvertInvalidEmbeddingFeaturesNullVector() {
