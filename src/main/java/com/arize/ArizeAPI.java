...
public interface ArizeAPI {
    ...
    <T> Future<HttpResponse> logPrediction(String modelId, final String modelVersion, final String predictionId,
     ...
     *                                  not supported.
     */
    <T> Future<HttpResponse> logActual(final String modelId, final String predictionId, final T actualLabel)
