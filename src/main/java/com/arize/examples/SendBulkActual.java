...
public class SendBulkActual {
    ...
    public static void main(final String[] args)
        ...
        final List<String> labels = new ArrayList<String>(Arrays.asList("Categorical Observed Label"));
        final List<String> predictionIds = new ArrayList<String>(Arrays.asList("id_12345"));

        final Response asyncResponse = arize.logBulkActual("modelId", predictionIds, labels);
