...
public class Response {
  ...
  /**
   * Waits if necessary for the computation to complete, and then retrieves the response code.
   *
  ...
  /**
   * Waits if necessary for the computation to complete, and then retrieves the response body.
   *
